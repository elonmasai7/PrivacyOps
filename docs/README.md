...
- `api-workflow-dsr.md` - DSR workflow API examples by OpenAPI tag
- `api-workflow-policies.md` - policies workflow API examples by OpenAPI tag
- `api-workflow-tasks.md` - tasks workflow API examples by OpenAPI tag
...
- `framework-pack-guide.md` - import/export and review process for framework packs
...
- `assets/` - architecture and workflow visuals used in project documentation
